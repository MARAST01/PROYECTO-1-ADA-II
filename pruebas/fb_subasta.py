...
if __name__ == "__main__":
    ...
    with open("fb_subasta.txt", "w") as archivo:
        ...
        archivo.write(f"{timeit.timeit(lambda: fuerza_bruta_sub(A2, B2, n2, params2), number=25)/25 * 1000}\n")
        print("prueba 2 terminada")

        archivo.write(f"{timeit.timeit(lambda: fuerza_bruta_sub(A3, B3, n3, params3), number=20)/20 * 1000}\n")
        print("prueba 3 terminada")

        archivo.write(f"{timeit.timeit(lambda: fuerza_bruta_sub(A4, B4, n4, params4), number=20)/20 * 1000}\n")
        print("prueba 4 terminada")

        archivo.write(f"{timeit.timeit(lambda: fuerza_bruta_sub(A5, B5, n5, params5), number=10)/10 * 1000}\n")
